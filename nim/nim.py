...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        # Convert the state list into a tuple to use it as a dictionary key
        state_tuple = tuple(state)
        
        # If the (state, action) pair is in self.q, return its value; otherwise, return 0
    ...
    def best_future_reward(self, state):
        ...
        # Get a list of all available actions in the given state
        ...
        # Find the maximum Q-value among available actions
